...
const en = {
  ...
  'menu.sortLocationAsc': 'Location (A1…)',
  'menu.sortReleasedAsc': 'Release Date (asc)',
  'menu.sortReleasedDesc': 'Release Date (desc)',
  'menu.save': 'Save',
  'menu.unsavedChanges': 'Unsaved Changes',
  'menu.saveGithub': 'Save (GitHub)',
  'menu.export': 'Export',
  'unsaved.title': 'Unsaved Changes',
  'unsaved.loading': 'Comparing with GitHub…',
  'unsaved.none': 'No movie changes versus the GitHub library.',
  'unsaved.error': 'Could not compare with GitHub.',
  'unsaved.added': 'Added',
  'unsaved.removed': 'Removed',
  'unsaved.changed': 'Changed',
  ...
  'settingsIo.exportDoneWithKeys': 'Settings exported (includes API keys)',
  ...
  'settings.bulkRefreshHint':
    'Menu → Collection → Refresh (TMDB) re-fetches every movie from TMDB. Location and format are kept; keywords are merged. A second “are you sure?” step is on by default.',
  'settings.connections': 'Connections',
  'settings.tmdbKey': 'TMDB API key',
  'settings.githubKey': 'GitHub API key',
  'settings.exportApiKeys': 'Settings export',
...
const de = {
  ...
  'menu.sortLocationAsc': 'Ablage (A1…)',
  'menu.sortReleasedAsc': 'Kinostart (aufsteigend)',
  'menu.sortReleasedDesc': 'Kinostart (absteigend)',
  'menu.save': 'Speichern',
  'menu.unsavedChanges': 'Ungespeicherte Änderungen',
  'menu.saveGithub': 'Speichern (GitHub)',
  'menu.export': 'Exportieren',
  'unsaved.title': 'Ungespeicherte Änderungen',
  'unsaved.loading': 'Vergleiche mit GitHub…',
  'unsaved.none': 'Keine Filmänderungen gegenüber der GitHub-Bibliothek.',
  'unsaved.error': 'Vergleich mit GitHub fehlgeschlagen.',
  'unsaved.added': 'Hinzugefügt',
  'unsaved.removed': 'Entfernt',
  'unsaved.changed': 'Geändert',
  'menu.releases': 'Releases',
  'menu.deployments': 'Deployments (GitHub)',
  ...
  'settingsIo.exportDoneWithKeys':
    'Einstellungen exportiert (enthält API-Schlüssel)',
  ...
  'dialog.addFormat': 'Format hinzufügen…',
  ...
  'settings.bulkRefreshHint':
    'Menü → Sammlung → Aktualisieren (TMDB) holt alle Filme von TMDB. Standort und Format bleiben; Schlagwörter werden zusammengeführt. Eine zweite Bestätigung ist standardmäßig an.',
  'settings.connections': 'Verbindungen',
  'settings.tmdbKey': 'TMDB-API-Schlüssel',
  'settings.githubKey': 'GitHub-API-Schlüssel',
  'settings.exportApiKeys': 'Einstellungen exportieren',
  'settings.exportApiKeysConfirm':
...
const es = {
  ...
  'menu.sortLocationAsc': 'Ubicación (A1…)',
  'menu.sortReleasedAsc': 'Fecha de estreno (asc)',
  'menu.sortReleasedDesc': 'Fecha de estreno (desc)',
  'menu.save': 'Guardar',
  'menu.unsavedChanges': 'Cambios sin guardar',
  'menu.saveGithub': 'Guardar (GitHub)',
  'menu.export': 'Exportar',
  'unsaved.title': 'Cambios sin guardar',
  'unsaved.loading': 'Comparando con GitHub…',
  'unsaved.none': 'No hay cambios de películas respecto a la biblioteca de GitHub.',
  'unsaved.error': 'No se pudo comparar con GitHub.',
  'unsaved.added': 'Añadidas',
  'unsaved.removed': 'Eliminadas',
  'unsaved.changed': 'Modificadas',
  'menu.releases': 'Releases',
  ...
  'settingsIo.exportDoneWithKeys': 'Ajustes exportados (incluye claves API)',
  ...
  'dialog.addFormat': 'Añadir formato…',
  ...
  'settings.bulkRefreshHint':
    'Menú → Colección → Actualizar (TMDB) vuelve a obtener cada película de TMDB. La ubicación y el formato se conservan; las palabras clave se fusionan. La segunda confirmación está activada por defecto.',
  'settings.connections': 'Conexiones',
  'settings.tmdbKey': 'Clave API de TMDB',
  'settings.githubKey': 'Clave API de GitHub',
  'settings.exportApiKeys': 'Exportar ajustes',
  'settings.exportApiKeysConfirm':
...
const fr = {
  ...
  'menu.sortLocationAsc': 'Emplacement (A1…)',
  'menu.sortReleasedAsc': 'Date de sortie (croissant)',
  'menu.sortReleasedDesc': 'Date de sortie (décroissant)',
  'menu.save': 'Enregistrer',
  'menu.unsavedChanges': 'Modifications non enregistrées',
  'menu.saveGithub': 'Enregistrer (GitHub)',
  'menu.export': 'Exporter',
  'unsaved.title': 'Modifications non enregistrées',
  'unsaved.loading': 'Comparaison avec GitHub…',
  'unsaved.none': 'Aucun changement de film par rapport à la bibliothèque GitHub.',
  'unsaved.error': 'Impossible de comparer avec GitHub.',
  'unsaved.added': 'Ajoutés',
  'unsaved.removed': 'Supprimés',
  'unsaved.changed': 'Modifiés',
  'menu.releases': 'Releases',
  ...
  'settingsIo.exportDoneWithKeys':
    'Paramètres exportés (inclut les clés API)',
  ...
  'dialog.addFormat': 'Ajouter un format…',
  ...
  'settings.bulkRefreshHint':
    'Menu → Collection → Actualiser (TMDB) recharge chaque film depuis TMDB. L’emplacement et le format sont conservés ; les mots-clés sont fusionnés. Une seconde confirmation est activée par défaut.',
  'settings.connections': 'Connexions',
  'settings.tmdbKey': 'Clé API TMDB',
  'settings.githubKey': 'Clé API GitHub',
  'settings.exportApiKeys': 'Export des paramètres',
  'settings.exportApiKeysConfirm':
